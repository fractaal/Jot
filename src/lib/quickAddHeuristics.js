const { ensureDayJs } = require('./time');
...
function parseDate(text, timezone = 'Asia/Manila') {
...
function parseWeekday(lowerText, now) {
...
function previousWeekday(reference, targetIndex) {
...
function closestPastWeekday(reference, targetIndex) {
...
function parseMerchantAndNotes(text, amount) {
  const cleaned = text
...
function guessCategory(text, fallback = 'Miscellaneous') {
...
function heuristicParse(text, timezone = 'Asia/Manila') {
